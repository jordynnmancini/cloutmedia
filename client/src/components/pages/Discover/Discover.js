      ...
      <div className="content">
        <div className="top">
          <div className="searchTop">
            ...
            >
              <option className="roleDrop" value="Artist">
                Artists/Musicians
              </option>
              <option classname="locationDrop" value="Sound Engineer">
                Sound Engineers
              </option>
            </select>
        ...
        <div className="bottom">
          <div className="results">
            {!results.length ? (
              ...
              <h3>
                {results[0].type}s in {results[0].primaryLocation}:{" "}
              </h3>
            )}
                      ...
                      return (
                        <ul className="eng1" key={key}>
                          ...
                          <button onClick={() => openModal(result)}>
                            <li className="info">More Info</li>
                          </button>
                        </ul>
                      );
                    })}
